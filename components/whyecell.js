...
export default function WhyECell() {
  return (
    <div className="relative w-full h-screen overflow-hidden">
      ...
      <div className="flex flex-col items-center justify-start h-full text-center text-white px-4 pt-20">
        <h1 className="text-7xl font-extrabold mb-6">
          Why E-Cell FCRIT<span className="text-blue-500">.</span>
        </h1>
        <p className="text-lg max-w-3xl leading-relaxed">
          For 18 years, E-Cell FCRIT has championed an entrepreneurial ethos,
          ...
          and independent thinking. E-Cell FCRIT inspires 'CHANGE' by instilling
